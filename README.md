...
You can add an account, but you need to install sudo. The commands are listed assuming you're using the root account. Add sudo if needed.
...
8. Pick a location to store your ini file. I suggest creating a .directory so it's not easily visible. The parent directory names doesn't matter. I like to keep config files in /etc because I back up that directory, especially when I have to do something exotic.
